...
@RestController
@RequestMapping("/api")
@Tag(name = "Rating", description = "評価API")
public class CompRatingRestController {

    private final CompRatingService compRatingService;

    @Operation(summary = "評価登録", description = "합격한 유저에 한해 평점을 주는 기능")
    ...
    @Operation(summary = "評価修正", description = "부여한 평점을 수정하는 기능")
    ...
    @Operation(summary = "評価削除" , description = "부여한 평점을 삭제하는 기능")
    ...
    @Operation(summary = "企業平均評価", description = "기업의 평점을 보여주는 기능")
